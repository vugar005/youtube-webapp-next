...
export default function BrandIcon(props: Props) {
    return (
        <Fragment>
            <div className={`${styles['brand-icon-host']} ${props.className}`}>
                <svg
                    viewBox="0 0 97 20"
                ...
                >
                    <g viewBox="0 0 97 20" preserveAspectRatio="xMidYMid meet" className="style-scope yt-icon">
                        ...
                        <g className="youtube-red-paths style-scope yt-icon">
                            <path
